...
This report lists each case and summarizes its progress, showing the dates that each step was
completed, and the status of each deliverable. All cases in the table are included, including those
on other pages. Any filters applied to the table will affect which cases are included. The report
is generated from any table of cases, including the main QC dashboard, and the Cases table on
various detail pages. To generate the report, apply any filters you'd like, then click the "Download
All" button and select "Case Summary Report" in the dialog.

The Case Summary Report is also available to external users.
...
the report, go to the Projects list page, select the projects you wish to report on, click the
"Download Selected" button, and choose "TGL Tracking Sheet" in the dialog.
...
click the "Download Selected" button, and select "Full-Depth Summary" in the dialog.
...
pages. To generate the report, select the cases you are interested in, click the "Download
Selected" button, and choose "DARE Input Sheet" in the dialog.
...
main QC dashboard, and the Cases table on various detail pages. To generate the report, apply any
filters you'd like, click the "Download All" button, and select "Case TAT Report" in the dialog.
