...
public record ExternalCase(
    ...
    List<ExternalSample> receipts,
    List<ExternalTest> tests,
    List<ExternalCaseDeliverable> deliverables,
    LocalDate startDate,
