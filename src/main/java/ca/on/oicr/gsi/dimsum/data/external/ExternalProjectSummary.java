...
public record ExternalProjectSummary(
    ...
    int extractionCompletedCount,
    int libraryPrepCompletedCount,
    int libraryQualCompletedCount,
    int fullDepthSeqCompletedCount,
    int analysisReviewCompletedCount,
    int releaseApprovalCompletedCount,
    int releaseCompletedCount) {
