...
public class MvcExceptionHandler {
  ...
  @Autowired private CommonModelAttributeProvider commonModelAttributeProvider;
  ...
  public ModelAndView handleResponseStatusException(
      ResponseStatusException ex, @AuthenticationPrincipal DimsumPrincipal principal) {
  ...
  public ModelAndView handleGeneralException(
      Exception ex, @AuthenticationPrincipal DimsumPrincipal principal) {
    return prepareErrorModelAndView(
        HttpStatus.INTERNAL_SERVER_ERROR, "Unexpected error", ex, principal);
  }

  private ModelAndView prepareErrorModelAndView(
      HttpStatusCode status, String errorMessage, Exception ex, DimsumPrincipal principal) {
    String resolvedErrorMessage = (errorMessage != null) ? errorMessage : "No message available";
